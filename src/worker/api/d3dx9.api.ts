...
import type { ModuleDescriptor, FunctionDescriptor, ParameterDescriptor } from "./types";
...
export const d3dx9Module: ModuleDescriptor = {
    ...
    functions: [
        ...
        makeFunc("D3DXMatrixMultiplyTranspose", 3),
        makeFunc("D3DXMatrixTranspose", 2),
        makeFunc("D3DXMatrixScaling", 4),
        makeFunc("D3DXMatrixRotationX", 2),
        makeFunc("D3DXMatrixRotationZ", 2),
        makeFunc("D3DXMatrixPerspectiveFovRH", 5),
        makeFunc("D3DXMatrixOrthoLH", 5),
        makeFunc("D3DXMatrixOrthoRH", 5),
        makeFunc("D3DXMatrixLookAtRH", 4),
        makeFunc("D3DXMatrixInverse", 3),
        makeFunc("D3DXVec3TransformNormal", 3),
        ...
        makeFunc("D3DXCreateFontA", 12),
        makeFunc("D3DXCreateFontW", 12),
        makeFunc("D3DXCreateFontIndirectA", 3),
        makeFunc("D3DXCreateFontIndirectW", 3),
